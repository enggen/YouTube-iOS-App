...
//            }
            ...
            if let title = video?.title {
                ...
                if estimatedRect.size.height > 20 {
                    titleLabelHeightConstraint?.constant = 44 // if text is two line
                } else {
                    titleLabelHeightConstraint?.constant = 20 // if text is one line
                }
            }
        }
    }
    ...
    override func setupViews() {
        ...
        addConstraintsWithFormat(format: "V:|-30-[v0]-8-[v1(44)]-36-[v2(1)]|", views: thumbnailImageView, userProfileImageView, separatorView)
